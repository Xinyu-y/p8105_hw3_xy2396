...
![](p8105_hw3_xy2396_files/figure-gfm/unnamed-chunk-13-1.png)<!-- --> We
can see from the resulting graph that, during the first three weeks, the
daily total activity was roughly increacing from Monday to Sunday; but
in the 4th and 5th week, the total activity increased a bit during
